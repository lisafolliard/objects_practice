...
describe(Contact) do
  ...
  describe('#last_name') do
    it('returns the last_name, first_name, job_title, and company') do
      test_contact = Contact.new({:last_name => "Smith", :first_name => "John"})
  ...
  describe('#save') do
    it('adds a contact to the array of saved contacts') do
      test_contact = Contact.new({:last_name => "Smith", :first_name => "Tom"})
      test_contact.save()
  ...
  describe('.clear') do
    it('empties out all of the saved contacts') do
      Contact.new({:last_name => "Smith", :first_name => "Tom"}).save()
      Contact.clear
      expect(Contact.all()).to(eq([]))
    end
  end
